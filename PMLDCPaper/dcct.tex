...
region is annotated with a consistency level capable of
...
The listing in Figure~\ref{fig:example} shows a simple schema with annotated
regions and actions. Fields in classes and singleton objects are annotated
with their consistency level.
