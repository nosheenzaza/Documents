...
% CHANGES:
% add a citation for causal order implementation
% add citations for common uses of eventual consistency
...
lists, and is widely used in practice~\cite{eventualeBay,eventualNetflix,hastorun2007dynamo}.
