...
premissive property that total atomicity.
...
local region, for which the version, action and consistency of source set are
tracked. Any reads from this set generate a similar set. In our system, we track
the flow of data among regions, and do not allow data.
