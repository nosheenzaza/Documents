...
% So far talking about what kinds of use cases require which consistency levels,
% now will talk about how frameworks do not facilitate that, because it is not
% so easy to reason about it, and how consistency requirements are defined in
% terms of replica state as well as data integrity, not both.



I could have a list of properties and consistency criteria
